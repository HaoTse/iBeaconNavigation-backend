<?php
/* Smarty version 3.1.28, created on 2016-09-10 02:51:05
  from "C:\xampp\htdocs\backend\web\view\field\fieldEdit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_57d30499df9f22_76663108',
  'file_dependency' => 
  array (
...
function content_57d30499df9f22_76663108 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
">
                                    ...
                                    <div id="fieldPhotoDiv" class="form-group">
                                        <label for="fieldPhoto" class="col-sm-2 control-label">場域圖片</label>
                                        <div class="col-sm-10">
                                            <input type="file" id="fieldPhoto" name="fieldPhoto" data-input="false">
                                            <img id="fieldPhotoImg" class="img-thumbnail" style="display:none" alt="場域圖片" src="<?php echo $_smarty_tpl->tpl_vars['field']->value['photo'];?>
"/>
                                        </div>
                                    </div>
                                    <div id="fieldMapDiv" class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img id="fieldMapImg" class="img-thumbnail" style="display:none" alt="場域地圖" src="<?php echo $_smarty_tpl->tpl_vars['field']->value['map_svg'];?>
"/>
                                        </div>
                                    </div>
                                </div>
